...
export default function SignalPanel({ signal, price, livePrice, priceRefreshing, tradePoints }) {
  ...
  return (
    <div className="card" style={{ borderColor }}>
      ...
      <div style={{ fontSize: '14px', lineHeight: '1.6' }}>{signal.recommendation}</div>
